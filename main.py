...
gender_prototext = "models/gender_deploy.prototxt"
...
gen = cv2.dnn.readNet(gender_model,gender_prototext)
...
for face_bound in face_bounds:
     try:
         face_img = img_cp[max(0, face_bound[1] - 15): min(face_bound[3] + 15, img_cp.shape[0]),
                            max(0, face_bound[0] - 15): min(face_bound[2] + 15, img_cp.shape[1])]
